...
const MOCK_INVENTORY_ITEMS: Item[] = [
  ...
  },
  {
    ...
    category_id: "6",
    type: "Lead-Acid",
    description: "High-quality car battery for most vehicles",
    is_oil: false,
    isOil: false,
  ...
  {
    id: "16",
    name: "Used Car Battery 12V 50Ah",
    price: 35.99,
    stock: 8,
    category: "Batteries",
    brand: "Generic",
    ...
    category_id: "6",
    type: "Lead-Acid",
    description: "Used car battery in good condition",
    is_oil: false,
    isOil: false,
    imageUrl: "/placeholders/battery.jpg",
    image_url: "/placeholders/battery.jpg",
    isBattery: true,
    batteryState: "resellable",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  {
    ...
    category_id: "6",
    type: "Lead-Acid",
    description: "Scrap car battery for recycling",
    is_oil: false,
    isOil: false,
    imageUrl: "/placeholders/battery.jpg",
    image_url: "/placeholders/battery.jpg",
  ...
  {
    id: "18",
    name: "Motorcycle Battery 12V 7Ah",
    price: 45.99,
    stock: 12,
    category: "Batteries",
    brand: "Yuasa",
    ...
    category_id: "6",
    type: "Lead-Acid",
    description: "Motorcycle battery for small engines",
    is_oil: false,
    isOil: false,
    imageUrl: "/placeholders/battery.jpg",
    image_url: "/placeholders/battery.jpg",
