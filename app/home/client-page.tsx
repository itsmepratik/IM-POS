...
import { useDashboardData, SalesMetrics } from "./hooks/useDashboardData";
...
export function HomePageContent({ initialSalesMetrics }: HomePageContentProps) {
  ...
  const { sales, profit, payments, lastUpdated, isLoading, isSalesLoading, isProfitLoading, setBranchFilter } =
    useDashboardData(initialSalesMetrics);
